...
.\scripts\run-bench-suite.ps1 -Path C:\ -Scanner ntfs -Iterations 5
.\scripts\run-bench-suite.ps1 -Path C:\ -Scanner fallback -Iterations 5 -Claim wiztree-ssd-500gb-typical
```
