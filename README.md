...
- egui desktop shell with background scans, live fallback progress counts, scanner mode selection, query-backed file filters, non-blocking CSV export, file actions, and tree, files, types, and treemap tabs.
